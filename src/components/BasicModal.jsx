                ...
                <Modal show={this.state.show} onHide={this.close}>
                    ...
                    <Modal.Body>
                        ...
                        <div style={{ display: "flex" }}>
                            <div style={{ width: "100px", paddingRight: "10px" }}>カテゴリ</div>
                        ...
                        <div>
                            {Object.keys(this.props.item).map(key => <div style={{ display: "flex" }}>
                                <div style={{ width: "100px", paddingRight: "10px" }}>{key}</div>
